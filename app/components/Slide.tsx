...
export default function HeroSection() {
  return (
    <div className="slideSection bg-[#FCF8F3] mt-28 px-6 lg:px-32 flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative">
      {/* Text Section */}
      <div className="slideText lg:mt-40 lg:ml-20 text-center lg:text-left max-w-lg">
        <h4 className="font-extrabold text-2xl md:text-4xl lg:text-5xl mb-6 leading-tight">
